...
func fire_shot():
	...
	var obj: RigidBody3D = projectile.instantiate()
	...
	obj.linear_velocity = weapon_manager.player.velocity \
		+ raycast.global_transform.basis * projectile_relative_velocity
