...
const game_over_scene: PackedScene = preload("res://scenes/screen/game_over_screen.tscn")
const pause_scene: PackedScene = preload("res://scenes/screen/pause_screen.tscn")
