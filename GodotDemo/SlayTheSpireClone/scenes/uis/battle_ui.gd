...
func _ready() -> void:
	...
	draw_pile_button.pressed.connect(func(): draw_pile_view.show_current_view("Draw Pile", true))
	discard_pile_button.pressed.connect(func(): discard_pile_view.show_current_view("Discard Pile"))
