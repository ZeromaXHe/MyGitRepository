...
1. 1. @component,@service,@controller,@controlleradvice，@Repository
   2. @Autowired，@Inject，@Resource,@Qualifier，一般@Resource单独使用，@Qualifier会和@Autowired一起用
   3. @dependsOn
